(ns sicp.chapter02.2-52
  (:require [sicp.chapter02.2-45 :refer [right-split up-split]]
            ...
            [sicp.chapter02.2-50 :refer [flip-horizontal rotate-counterclockwise-180deg
                                         transform-painter]]
            [sicp.chapter02.2-51 :refer [below beside]]))

(defonce rotate180deg rotate-counterclockwise-180deg)

(defn smile-wave-painter [paint-f]
...
(defn square-limit [painter n]
  (let [combiner4 (square-of-four rotate180deg flip-vertical
                                  flip-horizontal identity)]
